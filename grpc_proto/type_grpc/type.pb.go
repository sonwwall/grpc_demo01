...
const file_type_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x05.ItemR\x05value:\x028\x012+\n" +
...
var file_type_proto_goTypes = []any{
	...
	nil,                   // 5: MapRequset.ISEntry
	nil,                   // 6: MapRequset.SSEntry
	nil,                   // 7: MapRequset.SItemEntry
}
var file_type_proto_depIdxs = []int32{
	2, // 0: ArraryRequest.item_list:type_name -> Item
	5, // 1: MapRequset.i_s:type_name -> MapRequset.ISEntry
	6, // 2: MapRequset.s_s:type_name -> MapRequset.SSEntry
	7, // 3: MapRequset.s_item:type_name -> MapRequset.SItemEntry
	2, // 4: MapRequset.SItemEntry.value:type_name -> Item
	0, // 5: TypeService.Say:input_type -> Request
	1, // 6: TypeService.Say:output_type -> Response
